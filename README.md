...
**Network:**
- **FW01 (OPNsense)** — routing, ACLs, traffic logging
- Segmentation: **MGMT / CORP / SOC**

**Endpoints / servers (current + planned):**
- **DC01 (Windows Server)** — AD DS + DNS
- **WIN11-CL01** — domain-joined endpoint + baseline validation (telemetry next)
...
### Runbooks
- `runbooks/triage-portscan.md`
- `runbooks/triage-rdp-bruteforce.md`
...
- From **CORP**: DNS/NTP/HTTP(S) allowed (as defined), everything else blocked; Live View shows **BLOCK+LOG** hits
...
│  ├─ network-plan.md
│  ├─ threat-model.md
│  ├─ host-networking-kvm.md
│  ├─ fw01-opnsense-setup.md
│  ├─ fw01-firewall-policy.md
│  ├─ ad-setup-dc01.md
│  └─ win11-domain-join.md
├─ runbooks/
│  ├─ triage-portscan.md
